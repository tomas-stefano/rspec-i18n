...
prefer(If don't have your language, please make a fork). 
...
Rspec-i18n will supports any language(If don't have your language, please make a fork and send pull requests!)
...
Here is a simple example of Portuguese(Brazil):
    ...
    descreva Pessoa do
      ...
      contexto "a idade" do
        ...
        # se voce quiser pode usar exemplo ou especificar - (it)
        exemplo "deve ser opcional" do
      ...
      contexto 'maior de idade' do
        ...
        # voce pode colocar o assunto(subject) implicitamente ou explicitamente
...
Support for rspec 2.0 come soon!
