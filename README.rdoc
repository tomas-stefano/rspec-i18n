...
(See {languages.yml}{http://github.com/tomas-stefano/rspec-i18n/blob/master/lib/spec-i18n/languages.yml} file). 
...
See more examples in the {examples}{http://github.com/tomas-stefano/rspec-i18n/blob/master/examples/i18n} folder
